...
# Move eth2-val-tools
sudo mv $HOME/.asdf/installs/golang/1.23.2/packages/bin/eth2-val-tools /usr/local/bin
sudo mv $HOME/.asdf/installs/golang/1.23.2/packages/bin/ethereal /usr/local/bin